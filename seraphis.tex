...
Computational binding follows from contraposition: if $\mathcal{A}$ can find $(k_a^o, k_b^o, t_k)$ and $(k_a'^o, k_b'^o, t'_k)$ such that the two are \textit{not} equal and $\textsf{LinkTag}(k_a^o, k_b^o; t_k) = \textsf{LinkTag}(k_a'^o, k_b'^o; t'_k)$, then $(k_a^o / t_k, k_b^o / t_k)$ and $(k_a'^o / t'_k, k_b'^o / t'_k)$ already breaks the computational binding property of $(\textsf{Setup}, \textsf{PedersenK})$, and by Theorem \ref{thm-pedersen}, this breaks the DL assumption.
\end{proof}
