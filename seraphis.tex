...
From Omniring \cite{omniring}

Completeness: This property immediately follows from the completeness properties of the cryptographic components and by inspection of the protocol description.
\begin{itemize}
    \item \textit{Balance}:
    \item \textit{Privacy}:
